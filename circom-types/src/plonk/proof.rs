...
mod bls12_381_tests {
    ...
    use super::*;
    use crate::{test_utils, tests::plonk_bls12_381_kats};
    ...
    pub fn deserialize_bls12_381_proof() {
        ...
        let proof_string =
            std::fs::read_to_string(plonk_bls12_381_kats.join("circom.proof")).unwrap();
...
mod bn254_tests {
    ...
    pub fn deserialize_bn254_proof() {
        ...
        let proof_string = std::fs::read_to_string(plonk_bn254_kats.join("circom.proof")).unwrap();
